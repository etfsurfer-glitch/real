...
QUESTIONS = [
    # Z. 신규(2026-07-19): 비교·매물분석·타임머신 — 온톨로지 라우팅 회귀
    "헬리오시티랑 파크리오 비교해줘", "대치동이랑 잠실동 어디가 거래 활발해?",
    "둔산동 크로바 매물 잠기고 있어?", "잠실엘스 진짜 매물 몇 개야?",
    "8·2 대책이 뭐였어?", "2020년 부동산 시장 어땠어?", "임대차법 언제 시행됐어",
