...
LEAD = (
    "국토교통부와 대전광역시가 7월 15일 노후계획도시 정비 선도지구 3개 구역(둔산 13·14번, 송촌·중리·법동 "
    "6번) 선정을 발표한 직후, 대상 단지의 매물이 빠르게 회수되고 남은 매물의 호가는 역대 최고 실거래가를 "
...
BODY = [
    ("대상 단지는 어떤 곳인가 — 전 단지 준공 30년 초과, 둔산은 올해 신고가 경신 중",
     ...
     "한가람(1991년, 1,380가구)·공작한양(1992년, 1,074가구)이 둔산 14번 구역, 목련(1993년, "
     "1,166가구)·크로바(1992년, 1,632가구)가 13번 구역, 보람(1995년, 1,735가구)·삼익소월(1993년, "
     "810가구)이 송촌·중리·법동 6번 구역을 이룬다. 주목할 대목은 발표 이전부터 시장이 움직이고 있었다는 "
    ...
    ("발표 전엔 늘던 매물이 발표 직후 급감 — ‘회수 반전’",
     ...
     "회수 강도는 구역별로 달랐다. 둔산 14번 구역(한가람·공작한양)이 84건에서 65건으로 22.6% 줄어 가장 "
     "민감했고, 단지별로는 한가람이 31건에서 22건(-29.0%)으로 감소 폭이 가장 컸다. 둔산 13번 구역은 "
     "-13.0%, 송촌·중리·법동 6번 구역은 -7.6%였다. 올해 신고가를 경신한 둔산 쪽이 더 세게 잠겼고, "
...
METHOD = (
    "분석 방법 | 대상: 대전 선도지구 3개 구역 6개 단지(한가람·공작한양·목련·크로바·보람·삼익소월) 매매·전세 매물 및 "
...
TABLE = [  # 구역, 단지(위치·준공), 광고 7/14→7/18, 증감, 실매물 7/14→7/18 — 전부 콕집 DB 실측
    ...
    ("송촌·중리·법동 6", "보람 (법동 · 1995)", "30 → 26", "-13.3%", "20 → 17"),
    ("송촌·중리·법동 6", "삼익소월 (법동 · 1993)", "36 → 35", "-2.8%", "25 → 24"),
