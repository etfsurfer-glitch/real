...
SUBTITLE = "콕집 전수 분석 — 매물 227→121건(-46.7%) · 둔산은 2021년 고점 이미 넘어 호가 123%, 송촌은 아직 93%"
...
LEAD = (
    ...
    "8억 9,100만 원으로 7.3% 상승했다. 2021년 실거래 고점과 견주면 둔산 13·14구역은 이미 그 수준을 "
    "넘어섰고(실거래 회복률 중앙값 104%, 호가는 123%), 송촌 6구역은 실거래 93%·호가 92%로 아직 "
    "고점 아래다."
)
...
BODY = [
    ...
    ("2021년 고점과 견주면 — 둔산은 이미 넘었고, 송촌은 아직 못 왔다",
     "지방 아파트값은 2021년에 정점을 찍고 내려온 곳이 많다. 대상 6개 단지도 2021년 거래가 "
     "가장 활발했던 시기다. 그 해 실거래 고점과 지금을 평형별로 맞대어 보면 두 구역이 정반대에 서 있다. "
     "둔산 13·14구역은 올해 실거래가 이미 2021년 고점을 넘어섰다. 목련 135㎡가 2021년 14억 9,000만 "
     "원에서 올해 15억 5,000만 원(104%), 크로바 102㎡가 13억 4,000만 원에서 13억 9,800만 원(104%), "
     "공작한양 85㎡가 6억 5,000만 원에서 6억 7,000만 원(103%)으로 회복했고, 한가람 40㎡는 2억 8,000만 "
     "원에서 3억 5,000만 원으로 125%까지 올랐다. 회복률 중앙값은 104%다. 반면 송촌 6구역은 아직 "
     "고점 아래다. 보람 99㎡가 4억 3,000만 원에서 3억 3,500만 원으로 78%, 삼익소월 60㎡가 2억 1,000만 "
     "원에서 1억 7,300만 원으로 82%에 머물러 중앙값 93%다."),
    ("호가는 그보다 더 위 — 둔산은 2021년 고점의 123%",
     "지금 나와 있는 매물의 호가는 실거래보다 한 발 더 나가 있다. 둔산 단지들의 평형별 최고 호가는 "
     "2021년 고점의 107~143%(중앙값 123%)에 형성돼 있다. 크로바 134㎡가 2021년 16억 9,500만 원에서 "
     "현재 호가 23억 5,000만 원(139%), 한가람 40㎡가 2억 8,000만 원에서 4억 원(143%), 목련 117㎡가 "
     "13억 5,000만 원에서 18억 원(133%)이다. 실거래가 고점을 겨우 넘어선 것과 견주면 호가가 20%포인트 "
     "가까이 앞서 있는 셈이다. 송촌 6구역은 호가마저 2021년 고점의 79~95%(중앙값 92%)로 아직 아래에 "
     "있다. 보람 99㎡ 호가가 3억 5,000만 원으로 고점(4억 3,000만 원)의 81% 수준이다. 같은 날 발표된 "
     "선도지구인데도 시장이 두 구역을 전혀 다르게 값 매기고 있다는 뜻이다."),
    ...
    ("해석 시 유의점",
     ...
     "평형별 최고가 한 건씩을 맞댄 것이라 그 해 거래가 적었던 평형은 표본이 얇다."),
...
METHOD = (
    ...
    "287건)에서 평형(전용㎡ 반올림)별 최고가를 취한 값이며, 회복률=올해 같은 평형 최고 실거래÷2021년 "
    "고점, 호가 비율=현재 같은 평형 최고 호가÷2021년 고점. 지금 매물이 없는 평형은 비교에서 제외. "
